...
class TestCourseEndpoints:
    ...
    def test_create_course_invalid_arabic(self, client):
        """Test creating course with invalid Arabic name (English text in nameAr)"""
        course_data = {
            "semester": "1",
    ...
    def test_create_course_invalid_english(self, client):
        """Test creating course with invalid English name (Arabic text in nameEn)"""
        course_data = {
            "semester": "1",
            "nameAr": "مقدمة في البرمجة",
    ...
    def test_create_course_invalid_semester(self, client):
        """Test creating course with invalid semester (out of range 1-12)"""
        course_data = {
...
class TestPlanEndpoints:
    ...
    def test_create_plan_invalid_name(self, client):
        """Test creating plan with invalid name (empty string)"""
        plan_data = {
            "name": "",  # Empty name
            "maxCreditsPerSemester": 18,
            "courseIds": []
    ...
    def test_create_plan_invalid_credits(self, client):
        """Test creating plan with invalid max credits (> 40)"""
        plan_data = {
            "name": "Computer Science Plan",
            "maxCreditsPerSemester": 50,  # Too high (> 40)
            "courseIds": []
        }
        response = client.post("/plans", json=plan_data)
        assert response.status_code == 422  # Validation error
